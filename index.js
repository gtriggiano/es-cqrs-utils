...
function EventSourcedAggregateFactory ({type, getStreamName, initialState, reducer, commandsHandlers, serializeState, deserializeState}) {
  let _type = `${type}`
  ...
  Aggregate.name = _type
  Aggregate.toString = () => _type
