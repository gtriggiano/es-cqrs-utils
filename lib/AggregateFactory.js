...
function AggregateFactory({
  ...
  function Aggregate(aggregateId, aggregateSnapshot, aggregateEvents) {
    ...
    let aggregateEventsEmitters = events.reduce((emitters, Event) => Object.defineProperty(emitters, Event.type, { value: (data, consistencyPolicy = ENSURE_VERSION_CONSISTENCY) => {
